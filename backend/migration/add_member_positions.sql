...
VALUES
  ...
  ('OPERATIONS_MANAGER', '공장장', '관리/검토', NULL, 3, true, false, true),
  ('DEVELOPMENT_LEAD', '개발팀장', '개발관리', NULL, 4, true, false, true),
  ('DEVELOPER', '개발자', '직원', NULL, 5, true, false, true),
  ('DESIGNER', '디자이너', '직원', NULL, 6, false, false, true),
  ('MARKETER', '마케터', '직원', NULL, 7, false, false, true),
  ('CONTENT_MANAGER', '콘텐츠담당', '직원', NULL, 8, false, false, true),
