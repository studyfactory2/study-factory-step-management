...
export function InitialResultSection({
  ...
  return (
    <section className="rounded-[22px] border border-[#F2C9C2] bg-[#FFFEFC] px-4 py-4 shadow-[0_6px_0_#EFC6BE]">
      <h2 className="text-[17px] font-black text-[#3F2C28]">최초 결과물</h2>
      ...
      <div className="mt-3 min-h-10 rounded-[14px] border border-[#F2C9C2] bg-white px-4 py-3">
        <p className={`text-[13px] font-bold leading-4 ${firstComment?.oneLineComment ? "text-[#5A3E3B]" : "text-[#BFA4A0]"}`}>
...
function CommentHistoryCard({
  ...
  return (
    <section className="rounded-[22px] border border-[#F2C9C2] bg-[#FFFEFC] px-4 py-4 shadow-[0_6px_0_#EFC6BE]">
      <h2 className="text-[17px] font-black text-[#3F2C28]">코멘트</h2>
      <div className="mt-3 rounded-[16px] border border-[#F2C9C2] bg-white px-4 py-4">
        <p className="whitespace-pre-wrap text-[13px] font-bold leading-5 text-[#5A3E3B]">
      ...
      <div className="mt-3 min-h-10 rounded-[14px] border border-[#F2C9C2] bg-white px-4 py-3">
        <p className={`text-[13px] font-bold leading-4 ${comment.oneLineComment ? "text-[#5A3E3B]" : "text-[#BFA4A0]"}`}>
